...
{
	if (draw_subtab_button("ESP", (current_subtab_visuals == 0), 3, false)) current_subtab_visuals = 0;
	if (draw_subtab_button("Other", (current_subtab_visuals == 1), 3, false)) current_subtab_visuals = 1;
	if (draw_subtab_button("Removals", (current_subtab_visuals == 2), 3, false)) current_subtab_visuals = 2;
	if (draw_subtab_button("Chams", (current_subtab_visuals == 3), 3, true)) current_subtab_visuals = 3;
	...
	if (current_subtab_visuals == 3)
	{
		...
		ImGui::Combo("Enemy material", &g_variables->chams_material, materials, ARRAYSIZE(materials));
