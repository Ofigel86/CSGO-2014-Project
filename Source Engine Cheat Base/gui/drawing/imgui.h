...
namespace ImGui
{
    ...
    IMGUI_API bool          ColoredButton(const char* label, ImColor col, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    IMGUI_API bool          Button(const char* label, bool active, const ImVec2& size = ImVec2(0, 0));   // button
...
enum ImGuiCol_
{
    ...
    ImGuiCol_ModalWindowDimBg,      // Darken/colorize entire screen behind a modal window, when one is activ
    ImGuiCol_ColoredButton,
    ImGuiCol_ColoredButtonActive,
    ImGuiCol_ColoredButtonHovered,
    ImGuiCol_COUNT
};
